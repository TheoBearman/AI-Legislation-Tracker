// Branded email template generator for AI Legislation Tracker
...
export function renderBrandedEmail({
  ...
  // Updated to match AI Legislation Tracker theme
  ...
  const logoUrl = 'https://statepulse.me/logo.png'; // TODO: Update logo URL
  ...
  <div style="background:${brandColor};padding:40px 0;min-height:100vh;font-family:${interFont};color:#222;">
    <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:12px;box-shadow:0 2px 12px #0001;padding:32px 24px 24px 24px;">
      ...
      <div style="text-align:center;color:#888;font-size:0.95rem;margin-top:32px;font-family:${interFont};">AI Legislation Tracker &mdash; Stay informed. Stay engaged.</div>
    </div>
  </div>
  `;
}

    ...
    switch (type) {
      case 'bill':
        return title
          ...
          : `Track this AI legislation`;
      case 'rep':
        return title
          ? `See ${title}'s profile`
          : `See this representative's profile`;
      case 'map':
        return title
          ? `Explore ${title}'s AI legislation and representatives`
          : `Explore AI legislation and representatives`;
      default:
        return 'Check out this AI legislation';
    }
  };
  ...
  const handleWebShare = async () => {
    ...
    try {
      await navigator.share({
        title: title || 'AI Legislation Tracker',
        text: shareText,
        url: shareUrl,
      });
      toast({

...
async function sendSponsorshipNotificationEmail({
  ...
  const html = `
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #2563EB 0%, #1E40AF 100%); color: white; padding: 20px; border-radius: 8px 8px 0 0;">
            <h1 style="margin: 0; font-size: 24px;">📋 New Legislation Alert</h1>
            <p style="margin: 5px 0 0 0; opacity: 0.9;">AI Legislation Tracker Notification</p>
        </div>
        
        <div style="background: #f8f9fa; padding: 20px; border-radius: 0 0 8px 8px; border: 1px solid #e9ecef;">
            <p>Hi ${userName},</p>
            
            <p><strong>${representativeName}${repTitle}${repState}</strong>, whom you follow on AI Legislation Tracker, has sponsored new legislation${jurisdiction}:</p>
            
            <div style="background: white; padding: 16px; border-radius: 6px; border-left: 4px solid #2563EB; margin: 16px 0;">
            ...
            <div style="text-align: center; margin: 24px 0;">
                <a href="${legislationUrl}" style="background: #2563EB; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500; display: inline-block;">View Legislation Details</a>
            </div>
            
            <hr style="border: none; border-top: 1px solid #e9ecef; margin: 24px 0;">
            
            <p style="font-size: 12px; color: #6c757d;">
                You received this notification because you follow ${representativeName} on AI Legislation Tracker. 
                <br>
                <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://statepulse.me'}/settings" style="color: #2563EB;">Manage your notification preferences</a>
            </p>
            
            <div style="text-align: center; margin-top: 20px;">
                <p style="font-size: 12px; color: #6c757d; margin: 0;">
                    © ${new Date().getFullYear()} AI Legislation Tracker - Stay informed about AI policy
                </p>
            </div>
        </div>
    </body>
...
${representativeName}${repTitle}${repState}, whom you follow on AI Legislation Tracker, has sponsored new legislation${jurisdiction}:
